...
SystemPrompt = "You are a senior real esate agent from australia that helps people find right investment property."

# Environment variables
# Speech resource (required)
speech_region = "westeurope" #os.environ.get('SPEECH_REGION') # e.g. westus2
speech_key = "d95fc8b242644498b8a3e7c488ab3e61" #os.environ.get('SPEECH_KEY')
...
azure_openai_endpoint = "https://avatar-west-europe.openai.azure.com/" #os.environ.get('AZURE_OPENAI_ENDPOINT') # e.g. https://my-aoai.openai.azure.com/
azure_openai_api_key = "232fffb93cf243148539000856a1763f" #os.environ.get('AZURE_OPENAI_API_KEY')
azure_openai_deployment_name = "Avatar" #os.environ.get('AZURE_OPENAI_DEPLOYMENT_NAME') # e.g. my-gpt-35-turbo-deployment
...
def connectAvatar() -> Response:
    ...
    try:
        ...
        avatar_character = "lisa" #request.headers.get('AvatarCharacter')
        avatar_style = "casual-sitting" #request.headers.get('AvatarStyle')
